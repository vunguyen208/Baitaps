...
namespace Baitaps
{
    class EasyExercise
    {
        public void ShowMenu()
        {
            ...
            Console.WriteLine("Chọn bài số bao nhiêu? ( 1 -> 16)");
            int exerciseIndex = Convert.ToInt32(Console.ReadLine());
            easyExercise.exerciseIndex(exerciseIndex);
        ...
        public int[] insertArrray()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                Console.Write("Số[" + (i+1) + "]="); a[i] = Convert.ToInt32(Console.ReadLine());
            }
            return a;
        }
        ...
        public string ex3_Excute(int a, int b)
        {
            if (a % 2 == 0 && b % 2 == 0)
            {
                return "--> Tính chẵn lẻ của 2 số : đồng chẵn";
            }
            else if
            (a % 2 == 1 && b % 2 == 1)
            {
                return "--> Tính chẵn lẻ của 2 số : đồng lẻ";
            }
            else
            {
                return "--> Tính chẵn lẻ của 2 số : một chẵn một lẻ";
            }
        }
        ...
        public void exercise6()
        {
            ...
            Console.WriteLine("--> Tổng các số chẵn: " + sochan);
