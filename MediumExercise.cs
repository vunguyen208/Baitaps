...
namespace Baitaps
{
     class MediumExercise
    {
        ...
        {
            Console.WriteLine("Nhập chuỗi a");
        ...
        public int[] nhapmanga(int n)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                Console.Write("number[" + (i+1) + "]="); array1[i] = Convert.ToInt32(Console.ReadLine());
            }
            return array1;
        }
        public int[] nhapmangb(int n)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                Console.Write("number[" + (i+1) + "]="); array2[i] = Convert.ToInt32(Console.ReadLine());
            }
            return array2;
        }
        ...
        public void exercise1()
        {
            ...
            Console.WriteLine("Sắp xếp 1 mảng theo thứ tự tăng hoặc giảm(+ : tăng, - : giảm):");
        ...
        public void exercise7()
        {
            ...
            else
            {
                ...
                if (cuoi < dau || cuoi > n) { Console.WriteLine("Nhập giá trị sai"); }
                else 
                {
        ...
        {
            Console.WriteLine("Bài 9: Tổng sô các phần tử chuỗi a trong chuỗi b");
            String a = nhapchuoia();
            String b = nhapchuoib();
        ...
        public void exercise13()
        {
            ...
            Console.WriteLine("Nhập giờ checkin");
            checkin = Convert.ToInt32(Console.ReadLine());
            if(checkin>=24|| checkin < 0)
            {
                Console.WriteLine("Nhập số giờ trong khoảng từ 0 đến 24");
                
            }
            else 
            {
                Console.WriteLine("Nhập giờ checkout");
        ...
        public void exercise14()
        {
            ...
            Console.WriteLine("Nhập số tháng lương:");
            int n = Convert.ToInt32(Console.ReadLine());
        ...
        public void exercise17()
        {
            ...
            Console.WriteLine("Nhập vào vị trí ban đầu:");
            int a= Convert.ToInt32(Console.ReadLine());
            if (a <= 0)
            {
                Console.WriteLine("Nhập vào vị trí lớn hơn 0");
            ...
            {
                Console.WriteLine("Nhập vào vị trí kết thúc:");
                int b = Convert.ToInt32(Console.ReadLine());
                if ( b < a) 
                {
                    Console.WriteLine("Nhập vào vi trí kết thúc lớn hơn vị trí ban đầu. ");
                }
                else if (b > str.Length - a + 1)
                {
                    Console.WriteLine("Số kí tự cần cắt nằm ngoài số lượng cho phép");
                }
                else
                {
        ...
        public void exercise18()
        {
            ...
            {
                Console.WriteLine("Nhập vào số kí tự cần cắt:");
                int b = Convert.ToInt32(Console.ReadLine());
                if (b <= 0)
                {
                    Console.WriteLine("Nhập vào số kí tự lớn hơn 0");
                }
                else if (b > str.Length - a + 1)
                {
                    Console.WriteLine("Số kí tự cần cắt nằm ngoài số lượng cho phép");
        ...
        public void theoryExcercise()
        {
            ...
            Console.WriteLine("Bai 22: Stack có 1 đầu để nhận dữ liệu và truy xuất dữ liệu , queue có 2 đầu: 1 đầu để nhận dữ liệu va 1 đầu truy xuất dữ liệu");
        }
    }
}
