...
namespace Baitaps
{
    class HardExercise
    {
        ...
        public void exercise2()
        {
            ...
            catch (Exception ex) { Console.WriteLine("Gia trị của số b phải lớn hơn số a"); }
        ...
        public void exercise8()
        {
            ...
            Console.WriteLine("Nhập vào 1 số là bội số của 1000");
        ...
        public void exercise9()
        {
            ...
            Console.WriteLine("Nhập vào chuỗi a");
            string a = Console.ReadLine();
            Console.WriteLine("Nhập vào chuỗi b");
